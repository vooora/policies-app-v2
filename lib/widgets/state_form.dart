...
import 'package:policies_new/screens/language_screen.dart';
...
class _StateFormState extends State<StateForm> {
  ...
  Widget build(BuildContext context) {
    List<String> secondList = [
      ...
      translateToLanguage(29, getLanguageNum(selectedLanguage)),
      translateToLanguage(30, getLanguageNum(selectedLanguage)),
      translateToLanguage(31, getLanguageNum(selectedLanguage)),
      translateToLanguage(32, getLanguageNum(selectedLanguage)),
      translateToLanguage(33, getLanguageNum(selectedLanguage)),
      translateToLanguage(34, getLanguageNum(selectedLanguage)),
      translateToLanguage(35, getLanguageNum(selectedLanguage)),
      translateToLanguage(36, getLanguageNum(selectedLanguage)),
    ];
              ...
              child: Card(
                  child: Padding(
                      ...
                      child: Column(children: [
                        Text(prompts[getLanguageNum(selectedLanguage)].title1,
                        ...
                        DropdownButtonFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              label: Text(
                                  prompts[getLanguageNum(selectedLanguage)]
                                      .label2,
                          ...
                          onChanged: (String? value) {
                            ...
                            _saveStatePreference(translateStateToEnglish(
                                secondDropdownValue, secondList));
                          },
                          items: secondList
                            ...
                            return DropdownMenuItem<String>(
                              value: value,
                              child:
                                  Text(value, style: TextStyle(fontSize: 10.9)),
                            );
                          }).toList(),
                        ),
                        SizedBox(
